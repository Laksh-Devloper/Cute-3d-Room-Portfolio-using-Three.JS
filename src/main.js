...
scene.background = new THREE.Color("#c17de8");
...
// Enable proper color rendering from Blender materials
...
let letter1, letter2, letter4, letter5, letter6;
...
loader.load("/models/room20.glb", (glb) => {
  glb.scene.traverse((child) => {
    if (child.isMesh) {
      ...
      if (child.name.includes("Water")) {
        ...
        child.name.includes("Rackets") ||
        child.name.includes("Table Tennis") ||
        child.name.includes("Caramel Baby") ||
        child.name.includes("N120622") ||
        // Chair parts (old)
        child.name.includes("chair_seat") ||
        child.name.includes("chair_legs") ||
        child.name.includes("chair_pillow") ||
        // New chair parts
        child.name.includes("Chair_Back_0") ||
        child.name.includes("Chair_Legs_0") ||
        child.name.includes("Chair_Sit_0") ||
        // Headphones (Object_0 to Object_8)
        (child.name.startsWith("Object_") && child.name.length <= 8) ||
        // Fox parts
        child.name.includes("Fox_0") ||
        // Cigarettes
        child.name.includes("CigaretteBox") ||
        child.name.includes("Cigarette_MTL") ||
        // Coffee (the numbered Objects)
        child.name.includes("Object_0001") ||
        child.name.includes("Object_1001") ||
        child.name.includes("Object_2001") ||
        child.name.includes("Object_3001") ||
        child.name.includes("Object_4002") ||
        child.name.includes("Object_5001") ||
        child.name.includes("Object_6001") ||
        child.name.includes("Object_1003") ||
        child.name.includes("Object_2003") ||
        child.name.includes("Object_0003") ||
        child.name.includes("Object_3003") ||
        // Devil's book
        child.name.includes("boold_mat") ||
        // Character/anime figure parts
        child.name.includes("body_") ||
        child.name.includes("eye_") ||
        child.name.includes("face_") ||
        child.name.includes("hair_") ||
        child.name.includes("hand_") ||
        child.name.includes("headobject_") ||
        child.name.includes("Leg_") ||
        // Default materials (various objects)
        child.name.includes("defaultMaterial") ||
        // Stereo system
        child.name.includes("Stereo_textured_mesh") ||
        // Sofa/couch
        child.name.includes("Base_LP") ||
        child.name.includes("Pata_LP") ||
        child.name.includes("Sillon_LP")
      ) {
        // Convert MeshPhysicalMaterial to MeshBasicMaterial (doesn't need lights)
        // Preserve all the color and texture data from Blender
...
const socialLinks = {
  GitHub: "https://github.com/Laksh-Devloper",
};
